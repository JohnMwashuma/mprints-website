            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="project-name overflow">
                        <h2 class="bold">Bak Fashion Logo</h2>
                    ...
                    <div class="project-info overflow">
                        <h3>Project Info</h3>
                        <p>MPrints design nice 2d and 3d logos for bussinesses ranging from small SME'S to large Coorperates.</p>
                         <h3>Logo Design Prices</h3>
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i> 2d Logo Designs: 7,000/=.</li>
                            <li><i class="fa fa-angle-right"></i> 3d Logo Designs: 20,000/=.</li>
                            <li><i class="fa fa-angle-right"></i> Total Cost Range from 7,000/= to 20,000/=.</li>
                        </ul>
                    </div>
                    ...
                    <div class="client overflow">
                        <h3>Client:</h3>
                        <ul class="nav navbar-nav navbar-default">
                            <li><a href="#"><i class="fa fa-bolt"></i>Bak Fashions</a></li>
                        </ul>
                    </div>
