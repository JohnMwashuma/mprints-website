                    ...
                    <div class="sidebar portfolio-sidebar">
                        <div class="sidebar-item categories">
                            ...
                            <ul class="nav navbar-stacked">
                                <li class="active"><a href="portfolio.php">Graphic Designs<span class="pull-right">(6)</span></a></li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item design logos">
                            <div class="portfolio-wrapper">
                                ...
                                <div class="portfolio-info ">
                                    <h2>Designing product lauch Posters</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item design logos">
                        ...
                        <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item design logos">
                            <div class="portfolio-wrapper">
                                <div class="portfolio-single">
                                    <div class="portfolio-thumb">
                                        <img src="images/portfolio/mindflexbanner.png" class="img-responsive" alt="">
                                    </div>
                                    <div class="portfolio-view">
                                        <ul class="nav nav-pills">
                                            <li><a href="project5-details.php"><i class="fa fa-link"></i></a></li>
                                            <li><a href="images/portfolio/mindflexbanner.png" data-lightbox="example-set"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="portfolio-info ">
                                    <h2>Designing Seminar Banners</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-4 portfolio-item design logos">
                            <div class="portfolio-wrapper">
                                <div class="portfolio-single">
                                    <div class="portfolio-thumb">
                                        <img src="images/portfolio/mindflexbanners.png" class="img-responsive" alt="">
                                    </div>
                                    <div class="portfolio-view">
                                        <ul class="nav nav-pills">
                                            <li><a href="project6-details.php"><i class="fa fa-link"></i></a></li>
                                            <li><a href="images/portfolio/mindflexbanners.png" data-lightbox="example-set"><i class="fa fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="portfolio-info ">
                                    <h2>Designing Conference Banners</h2>
                                </div>
                            </div>
                        </div>
