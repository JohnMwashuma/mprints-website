...
<body>
    ...
    <section id="portfolio-information" class="padding-top">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="images/portfolio-details/model3.png" class="img-responsive" alt="">
                </div>
                <div class="col-sm-6">
                    <div class="project-name overflow">
                        <h2 class="bold">Fashion Model</h2>
                        <ul class="nav navbar-nav navbar-default">
                            <li><a href="#"><i class="fa fa-clock-o"></i>February11,2014</a></li>
                            <li><a href="#"><i class="fa fa-tag"></i>Modelling</a></li>
                        </ul>
                    </div>
                    <div class="project-info overflow">
                        <h3>Project Info</h3>
                        <p>MPrints do photography for fashion models which are of hiigh resolution i.e HD Photos</p>
                         <h3>Photography Prices</h3>
                        <ul class="elements">
                            <li><i class="fa fa-angle-right"></i> Full Body Photographs: 20,000/=.</li>
                            <li><i class="fa fa-angle-right"></i> Half Body Photographs: 5,000/=.</li>
                            <li><i class="fa fa-angle-right"></i> Total Cost Range from 6,000/= to 20,000/=.</li>
                        </ul>
                    </div>
